...
export const buildAltText = (settings: SettingValues<SorryImLateSettings>) => {
  ...
  return (
    ...
    `In the second panel, another${heightDescription} woman in a leather jacket and shoulder length brown hair is leaning through the doorway saying ${panel2Description}. ` +
