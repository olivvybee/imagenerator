...
export const hierarchyOfNeedsGenerator: Generator<HierarchyOfNeedsSettings> = {
  ...
  settings: {
    ...
    segment2: {
      ...
      name: 'Segment 2',
      params: {},
      when: (settings) => (settings.numberOfSegments as number) >= 2,
    },
    segment3: {
      type: SettingType.Text,
      name: 'Segment 3',
      params: {},
      when: (settings) => (settings.numberOfSegments as number) >= 3,
    },
    segment4: {
      type: SettingType.Text,
      name: 'Segment 4',
      params: {},
      when: (settings) => (settings.numberOfSegments as number) >= 4,
    },
    segment5: {
      type: SettingType.Text,
      name: 'Segment 5',
      params: {},
      when: (settings) => (settings.numberOfSegments as number) >= 5,
    },
  },
};
